...
public enum MEXLang implements ILangEntry {
    ...
    HEART_TRANSFER_RANGE("gui", "mekanism_heart.transfer_range"),
    HEART_RECEIVERS("gui", "mekanism_heart.receivers"),
    HEART_EXCLUDED_COUNT("gui", "mekanism_heart.excluded_count"),
    HEART_MACHINE_FILTERS("gui", "mekanism_heart.machine_filters"),
    HEART_NO_MACHINES("gui", "mekanism_heart.no_machines"),
    HEART_POWER_ON("gui", "mekanism_heart.power_on"),
    HEART_POWER_OFF("gui", "mekanism_heart.power_off"),
    HEART_CLICK_ENABLE("gui", "mekanism_heart.click_enable"),
    HEART_CLICK_DISABLE("gui", "mekanism_heart.click_disable"),
