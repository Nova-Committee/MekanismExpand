...
public class GuiAbstractWindGenerator<TILE extends AbstractWindGenerator> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiAbstractWindGenerator(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
