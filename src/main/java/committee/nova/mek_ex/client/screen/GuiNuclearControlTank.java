...
public class GuiNuclearControlTank extends GuiMekanismTile<TileEntityNuclearControlTank, MekanismTileContainer<TileEntityNuclearControlTank>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 49, 21, 84, 46, () -> {
            ...
            NuclearControlTankMultiblockData multiblock = tile.getMultiblock();
            ...
            ret.add(MekanismLang.GENERIC_MB.translate(mekanism.common.util.text.TextUtils.format(capacity)));
            return ret;
        }).spacing(1));
    ...
    private <STACK> void addStored(List<Component> ret, STACK stack, ToLongFunction<STACK> amountGetter) {
        ...
        ret.add(MekanismLang.GENERIC_MB.translate(mekanism.common.util.text.TextUtils.format(amountGetter.applyAsLong(stack))));
    }
