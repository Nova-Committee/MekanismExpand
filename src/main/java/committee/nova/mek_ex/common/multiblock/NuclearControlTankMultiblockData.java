...
public class NuclearControlTankMultiblockData extends MultiblockData implements IValveHandler {
    ...
    public NuclearControlTankMultiblockData(TileEntityNuclearControlTank tile) {
        super(tile);
        ...
        mergedTank = MergedTank.create(
              ...
              VariableCapacityChemicalTank.create(this::getChemicalTankCapacity, this.formedBiPred(), this.formedBiPred(),
                    ConstantPredicates.alwaysTrue(), ChemicalAttributeValidator.ALWAYS_ALLOW, saveAndComparator)
        );
    ...
    private List<IInventorySlot> createBaseInventorySlots() {
        ...
        slots.add(inputSlot = HybridInventorySlot.inputOrDrain(mergedTank, this, 146, 21));
        slots.add(outputSlot = HybridInventorySlot.outputOrFill(mergedTank, this, 146, 51));
